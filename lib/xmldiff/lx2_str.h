...
typedef std::basic_string<xmlChar> xmlChar_string;
...
/* 
// If more complex operation are needed, use this :

class xmlstring : public xmlChar_string
{
public:
    xmlChar_string(string str)
    {
        xmlChar * 
    }
...
typedef xmlChar_string xmlstring;
