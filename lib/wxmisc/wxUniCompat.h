...
#ifndef __WXUNICOMPAT_H__
#define __WXUNICOMPAT_H__
...
#include <libxmldiff/libxmldiff.h>  // for xmlstring

// Undefine that to force the use of libxml2 conversion functions
// #define wxUNICOMPAT 
